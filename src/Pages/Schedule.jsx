...
const Schedule = () => {
  ...
  if (currentWeek === 1 || currentWeek === 3) {
    piketGroup = [
      ["Haecal", "Herlambang", "Nabil", "Nia"],
      ["Dion", "Zaki", "Raihan", "Mutmainnah"],
      ["Akmal", "Reza Mauladi", "Ricardo", "Melda"],
      ["Wahyu", "Yudit", "Rahmat", "April"],
      ["Janualdhy", "Zevan", "Desi", "Anjelika"],
      ["Rafi", "Ijal", "Fajar", "Widiya"],
    ];
